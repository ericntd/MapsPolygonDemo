...
public class GeoHashUtils {
    ...
    public static double[] decode(String geohash) {
        ...
        return new double[]{latInterval[0], latInterval[1], lngInterval[0], lngInterval[1]};
    }

    public static void main(String[] args) {
        String geohash = "qqgvne";
        double[] latLngs = decode(geohash);
        System.out.println(String.format("lat longs of the rectangle are: %s", Arrays.toString
                (latLngs)));
    }
}
